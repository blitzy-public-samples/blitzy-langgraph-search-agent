...
# -----------------------------------------------------------------------------
# Creates the complete ECS Fargate infrastructure:
...
locals {
  ...
  # Computed ALB name (use provided or generate)
  alb_name = var.alb_name != "" ? var.alb_name : "${var.project_name}-alb"
...
# Memory-based scaling policy (optional, commented for now)
